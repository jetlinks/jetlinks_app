...
import 'package:jetlinks_app/utils/browser_url.dart';
                  ...
                  children: <Widget>[
                    ...
                    RichText(
                      text: TextSpan(children: <TextSpan>[
                        TextSpan(
                            text: "共链接 ", style: TextStyles.get12TextA8ACBC()),
                        TextSpan(
                            text: "230",
                            style: TextStyles.get15TextBold_373D52()),
                        TextSpan(
                            text: " 设备", style: TextStyles.get12TextA8ACBC()),
                      ]),
                    )
                  ],
                ),
                      ...
                      chart: BarChart(BarChartData(
                        ...
                        titlesData: FlTitlesData(
                          ...
                          bottomTitles: SideTitles(
                              showTitles: true,
                              textStyle:TextStyle(color: colorA8ACBC,fontSize: 10),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: RichText(
                text: TextSpan(children: <TextSpan>[
                  TextSpan(text: "设备: ", style: TextStyles.get12Text_373D52()),
                  TextSpan(
                      text: "网关、路灯、测试",
            ...
            Row(
              ...
              children: <Widget>[
                ...
                RoundButton(
                  text: "在线数量",
                  onPressed: () {
                    ToastUtils.showToast(context, "在线数");
                  },
                ),
              ],
            ),
                      ...
                      RichText(
                        text: TextSpan(children: <TextSpan>[
                          TextSpan(
                              ...
                              style: TextStyles.get15TextBold_373D52()),
                          TextSpan(
                              text: "台设备", style: TextStyles.get12TextA8ACBC()),
                        ]),
                      )
                    ],
                  ),
